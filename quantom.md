...
const hue = colorRange[0] + Math.random() _ (colorRange[1] - colorRange[0]);
particles.push({
size: particleSize,
position: { x: initialX, y: initialY },
offset: { x: 0, y: 0 },
shift: { x: initialX, y: initialY },
speed: particleSpeed + Math.random() _ particleSpeed,
targetSize: particleSize,
fillColor: generateColor(hue),
orbit: radius _ 0.5 + radius _ 0.5 \* Math.random(),
hue,
trail: []
});
}
