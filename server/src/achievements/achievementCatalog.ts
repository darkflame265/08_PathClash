...
const catalog: AchievementCatalogEntry[] = [
  ...
  ...Object.entries(defenseSkillNames).flatMap(([skillId, labels]) =>
    buildSeries('ability_defense', `skill_block_${skillId}_`, DEFENSE_SKILL_MILESTONES, DEFENSE_SKILL_REWARDS, (goal, rewardTokens) => ({
  ...
  ...Object.entries(utilitySkillNames).flatMap(([skillId, labels]) =>
    buildSeries('ability_utility', `skill_use_${skillId}_`, UTILITY_SKILL_MILESTONES, UTILITY_SKILL_REWARDS, (goal, rewardTokens) => ({
