  ...
  const refreshLobbyAccountSummary = useCallback(async () => {
    ...
    try {
      ...
      setAuthState({
        ...
        abilitySkillPresets: summary.abilitySkillPresets,
        ...
        vaultWins: summary.vaultWins,
        vaultRequiredWins: summary.vaultRequiredWins,
        vaultOpenedToday: summary.vaultOpenedToday,
