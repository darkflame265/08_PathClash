...
export const ABILITY_SKILLS: Record<AbilitySkillId, AbilitySkillDefinition> = {
  classic_guard: {
    ...
    name: { en: "Guard", kr: "가드" },
    loadoutTags: {
      en: "Timing: 0 · No moving after use",
  ...
  electric_blitz: {
    ...
    loadoutTags: {
      en: "Skill Move · No moving after use",
      kr: "스킬 이동 · 발동 후 이동 불가",
    },
    loadoutDescription: {
  ...
  wizard_magic_mine: {
    ...
    loadoutTags: { en: "Usable while moving", kr: "이동 중 사용 가능" },
    loadoutDescription: {
  ...
  cosmic_bigbang: {
    ...
    loadoutTags: {
      en: "Timing: 0–3 · No moving after use",
